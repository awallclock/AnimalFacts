...
aFacts.cat = {
    ...
    "Grapes and raisins, as well as onions, garlic, and chives, are all extremely harmful foods for cats. Grapes and raisins can cause kidney failure, meanwhile, onions, garlic, and chives wreak havoc on your cat's gastrointestinal system.",
    ...
    "It's believed that catnip produces an effect similar to LSD or marijuana in cats. The effects of nepetalactone — the chemical in catnip that can makes cats crazy — wears off within 15 minutes, and won't surface again for a few hours.",
    ...
    "Spaying and neutering can extend a cat's life. A study found found that neutered males live an average of 62 percent longer than unneutered cats and spayed females live an average of 39 percent longer than unspayed cats.",
    ...
    "When a cat slow blinks at you, it is a 'kitty kiss.' This movement shows contentment and trust.",
    ...
    "If a cat approaches you with a straight, almost vibrating tail, this means that they are extremely happy to see you.",
